      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class=" treeview {{ active_menu('manufacturers') [0] }}">
          ...
          <ul class="treeview-menu" style="{{ active_menu('manufacturers') [1] }}">
            <li class="active"><a href="{{ aurl('manufacturers') }}"><i class="fa fa-industry"></i> {{ trans('admin.manufacturers') }}</a></li>
        ...
        <li class=" treeview {{ active_menu('shipping') [0] }}">
          <a href="#">
            <i class="fa fa-truck" aria-hidden="true"></i> <span>{{ trans('admin.shipping') }}</span>
          </a>
          <ul class="treeview-menu" style="{{ active_menu('shipping') [1] }}">
            <li class="active"><a href="{{ aurl('shipping') }}"><i class="fa fa-truck" aria-hidden="true"></i> {{ trans('admin.shipping') }}</a></li>
        ...
        <li class=" treeview {{ active_menu('malls') [0] }}">
          <a href="#">
            <i class="fa fa-building" aria-hidden="true"></i> <span>{{ trans('admin.malls') }}</span>
          </a>
          <ul class="treeview-menu" style="{{ active_menu('malls') [1] }}">
            <li class="active"><a href="{{ aurl('malls') }}"><i class="fa fa-building" aria-hidden="true"></i> {{ trans('admin.malls') }}</a></li>
        ...
        <li class=" treeview {{ active_menu('colors') [0] }}">
          <a href="#">
            <i class="fas fa-palette"> </i> <span>{{ trans('admin.colors') }}</span>
          </a>
          <ul class="treeview-menu" style="{{ active_menu('colors') [1] }}">
            <li class="active"><a href="{{ aurl('colors') }}"><i class="fas fa-palette"> </i> {{ trans('admin.colors') }}</a></li>
         ...
         <li class=" treeview {{ active_menu('sizes') [0] }}">
          <a href="#">
            <i class="fas fa-info-circle"> </i> <span>{{ trans('admin.sizes') }}</span>
          </a>
          <ul class="treeview-menu" style="{{ active_menu('sizes') [1] }}">
            <li class="active"><a href="{{ aurl('sizes') }}"><i class="fas fa-info-circle"> </i> {{ trans('admin.sizes') }}</a></li>
         ...
         <li class=" treeview {{ active_menu('weights') [0] }}">
          <a href="#">
            <i class="fas fa-info-circle"> </i> <span>{{ trans('admin.weights') }}</span>
          </a>
          <ul class="treeview-menu" style="{{ active_menu('weights') [1] }}">
            <li class="active"><a href="{{ aurl('weights') }}"><i class="fas fa-info-circle"> </i> {{ trans('admin.weights') }}</a></li>
        ...
        <li class=" treeview {{ active_menu('products') [0] }}">
          <a href="#">
            <i class="fas fa-tag"> </i> <span>{{ trans('admin.products') }}</span>
          </a>
          <ul class="treeview-menu" style="{{ active_menu('products') [1] }}">
            <li class="active"><a href="{{ aurl('products') }}"><i class="fas  fa-tag"> </i> {{ trans('admin.products') }}</a></li>
