...
<div class="box">
  ...
  <div class="box-body">
   ...
   <div class="form-group">
        {!! Form::label('name_ar',trans('admin.shipping_name_ar')) !!}
        {!! Form::text('name_ar',$shipping->name_ar,['class'=>'form-control']) !!}
     </div>

     <div class="form-group">
        {!! Form::label('name_en',trans('admin.shipping_name_en')) !!}
    ...
    <div class="form-group">
     ...
     <div class="form-group">
       ...
       @if(!empty($shipping->icon) and Storage::has($shipping->icon))
       <img src="{{ Storage::url($shipping->icon) }}" style="width: 100px; height: 100px">
       @endif
