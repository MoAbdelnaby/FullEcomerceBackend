...
<div class="box">
  ...
  <div class="box-body">
   ...
   <div class="form-group">
        {!! Form::label('name_ar',trans('admin.manfact_name_ar')) !!}
        {!! Form::text('name_ar',$manufact->name_ar,['class'=>'form-control']) !!}
     </div>

     <div class="form-group">
        {!! Form::label('name_en',trans('admin.manfact_name_en')) !!}
     ...
     <div class="form-group">
        {!! Form::label('icon',trans('admin.manfact_icon')) !!}
        {!! Form::file('icon',['class'=>'form-control']) !!}

       @if(!empty($manufact->icon) and Storage::has($manufact->icon))
       <img src="{{ Storage::url($manufact->icon) }}" style="width: 100px; height: 100px">
       @endif
